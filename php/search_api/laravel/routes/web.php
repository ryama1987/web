...
Route::group(['prefix' => 'search'], function () {
    ...
    Route::get('/natural', [FullTextIndexController::class,'getjobDataNatural']);
    Route::get('/bool', [FullTextIndexController::class,'getjobDataBoolean']);
    Route::get('/test', [FullTextIndexController::class,'testdatafunc']);
});
